...
import eu.opends.basics.SkyPropertiesReader;
...
{	
    ...
    public void simpleInitApp() 
    {
        ...
        Spatial sky = SkyFactory.createSky(assetManager, "Textures/Sky/Clouds/clouds.properties", EnvMapType.CubeMap);

       /* Spatial sky = null;//= SkyFactory.createSky(assetManager, "Textures/Sky/Clouds/clouds.properties", EnvMapType.CubeMap);
        try {
			sky = SkyPropertiesReader.getSettings(assetManager, "Textures/Sky/Clouds/clouds.properties");
		} catch (Exception e) {
			e.printStackTrace();
		}
        */
