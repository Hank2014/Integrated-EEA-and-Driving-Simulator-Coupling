...
public class SimulationBasics extends SimpleApplication 
{
	...
	protected MyBulletAppState bulletAppState;
	protected SyncManager sym;
	...
	protected float pausePeriod = 0.1f;
	protected float screenshotPeriod = 0.1f;
	protected float elapsedBulletTimeSinceUpdate = 0.0f;
	protected float elapsedBulletTimeSinceScreenshot = 0.0f;
	...
	public Node getOpenDriveNode()
	{
		return openDriveNode;
	}
    ...
    public MyBulletAppState getBulletAppState() 
    {
	...
	public static DrivingTask getDrivingTask() // static
	{
		return drivingTask;
	}
    ...
    {    	
    	...
    	// init physics
        bulletAppState = new MyBulletAppState();
        stateManager.attach(bulletAppState);
        sym = new SyncManager(bulletAppState);
		...
		sceneNode.attachChild(openDriveNode);
