...
public class StartPropertiesReader
{
	...
	private boolean showAdvancedGui = false;
	private String drivingTaskPath = "";
	private String driverName = "";
	private boolean enableDetailedProfiler = false;
	
	
	public AppSettings getSettings() 
	{	
		try {
		        FileInputStream inputStream = new FileInputStream(System.getProperty("user.dir")+"/startProperties.properties");
        ...
        if(loadDefaults)
        {
	        ...
	        showAdvancedGui = getBooleanProperty("guiAdvanced", false);
	        
	        enableDetailedProfiler = getBooleanProperty("enableDetailedProfiler", false);
	...
	public boolean showAdvancedGUI() {
		return showAdvancedGui;
	}
	
	public boolean enableDetailedProfiler() {
		return enableDetailedProfiler;
	}
