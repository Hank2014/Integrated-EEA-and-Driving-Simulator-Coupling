...
public class SimulationDefaults 
{
	...
	public static boolean showAdvancedGUI = false;
	...
	public static String skyTexture = "/assets/Textures/Sky/Bright/mountain.dds";
	//public static String skyTexture = System.getProperty("user.dir")+"Textures/Sky/Bright/mountain.dds";
	...
	public static Boolean leftHandSideSteering = true;
	
	public static Boolean enableDetailedProfiler = false;
